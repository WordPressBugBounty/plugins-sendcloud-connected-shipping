...
namespace SCCSP\SendCloud\Connected\Shipping\Database\Utility;
 ...
 *
 * @package SCCSP\SendCloud\Connected\Shipping\Database\Utility
 */
class SCCSP_Migration_Reader {
	 ...
	 *
	 * @return SCCSP_Abstract_Migration|null
	 */
	...
	private function get_class_name( $version ) {
		return 'SCCSP\\SendCloud\\Connected\\Shipping\\Database\\Migrations\\Migration_' . str_replace( '.', '_', $version );
	}
}
